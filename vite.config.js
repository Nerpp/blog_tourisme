  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        commentsStyles: fileURLToPath(new URL('./assets/styles/comments.css', import.meta.url)),
        ...
        adminFieldTool: fileURLToPath(new URL('./assets/styles/admin/field-tool.css', import.meta.url)),
        adminFieldGps: fileURLToPath(new URL('./assets/styles/admin/field-gps.css', import.meta.url)),
        adminPrevisionDestinations: fileURLToPath(new URL('./assets/styles/admin/prevision-destinations.css', import.meta.url)),
        adminStudio: fileURLToPath(new URL('./assets/styles/admin/studio.css', import.meta.url)),
        adminStudioRoute: fileURLToPath(new URL('./assets/styles/admin/studio-route.css', import.meta.url)),
        adminStudioPlace: fileURLToPath(new URL('./assets/styles/admin/studio-place.css', import.meta.url)),
        adminTraffic: fileURLToPath(new URL('./assets/styles/admin/traffic.css', import.meta.url)),
